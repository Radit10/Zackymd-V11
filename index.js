...
module.exports = alpha = async (alpha, m, chatUpdate, store) => {
    try {
        var body = (m.mtype === 'conversation') ? m.message.conversation : (m.mtype == 'imageMessage') ? m.message.imageMessage.caption : (m.mtype == 'videoMessage') ? m.message.videoMessage.caption : (m.mtype == 'extendedTextMessage') ? m.message.extendedTextMessage.text : (m.mtype == 'buttonsResponseMessage') ? m.message.buttonsResponseMessage.selectedButtonId : (m.mtype == 'listResponseMessage') ? m.message.listResponseMessage.singleSelectReply.selectedRowId : (m.mtype == 'templateButtonReplyMessage') ? m.message.templateButtonReplyMessage.selectedId : (m.mtype == 'messageContextInfo') ? (m.message.buttonsResponseMessage?.selectedButtonId || m.message.listResponseMessage?.singleSelectReply.selectedRowId || m.text) : ""
 		var budy = (typeof m.text == 'string' ? m.text : '') //edit '' kalo ada prefix jadi work //punya gw
        ...
        //const command = body.slice(1).trim().split(/ +/).shift().toLowerCase() //edit comand pake prefix //punya gw
...
let chats = global.db.data.chats[m.chat] //punya gw
...
//━━━━━━━━━━━━━━━━━━━━━━[ Voice ]━━━━━━━━━━━━━━━━━━━━━━━━━━//
		...
		//punya gw
		if (autovoice){
           if (budy.match(/(a(su|nj(([ie])ng|([ie])r)?)|me?me?k|ko?nto?l|ba?bi|fu?ck|ta(e|i)k|bangsat|g([iueo])bl([iueo])(k|g)|g ([iueo]) b l ([iueo]) (k|g)|a (n j (i n g|i r)?)s u|col(i|ay)|an?jg|b([ia])ngs([ia])?t|t([iuo])l([iuo])l)/gi)) {
...
Lihat list Pesan Dengan ${prefix}listmsg`)
	...
	case 'antiviewonce': case 'antionce':
        ...
        reply(`${command} Berhasil Di Nonaktifkan !`)
			...
			break
case 'banchat': case 'banchats': case 'mute': //punya gw
if (!m.isGroup) return reply(lang.groupOnly())
        ...
        reply(`NsFw Berhasil Di Nonaktifkan !`)
			...
			if (args[0] === "on") {
				...
				reply(`antivirus Berhasil Di Aktifkan !`)
				} else if (args[0] === "off") {
					...
					reply(`antivirus Berhasil Di Nonaktifkan !`)
					} else {
	    ...
	    case 'toimage': case 'toimg': { //punya gw
                ...
                exec(`ffmpeg -i ${media} ${ran}`, (err) => {
                    fs.unlinkSync(media)
                    if (err) return reply('Sticker Gambar Asu Bukan Video')
...
await alpha.sendMessage(m.chat, buttodMessage)
